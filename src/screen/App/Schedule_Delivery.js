...
<Ionicons name="chevron-back-sharp" size={24} color="#1D3557" />        
      ...
      <View style={styles.bottomSheet}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <RText style={styles.header}>Schedule Delivery</RText>

          {/* Pickup */}
          <SectionTitle title="Pickup Location" style={styles.title} />
          ...
          {/* Delivery */}
          <SectionTitle title="Delivery Location" style={styles.title} />
          <GreyBox style={styles.locationCard}>
            <View style={styles.row}>
          ...
          <View style={styles.dateTimeRow}>
            <View style={styles.inputWrapper}>
              <SectionTitle title="Date" style={{ marginBottom: 8 }} />
              <GreyBox style={styles.inputGreyBox}>
                <TextInput
            ...
            <View style={styles.inputWrapper}>
              <SectionTitle title="Time" style={{ marginBottom: 8 }} />
              {/* <GreyBox style={styles.inputGreyBox}>
                <TextInput
                  placeholder="HH:MM"
                  style={styles.input}
    ...
    backgroundColor: "#F4F7F8",
          ...
          >
            <Text style={{ fontSize: 13, color: '#6D6D6D' }}>3:30 PM</Text>
            <Ionicons name="chevron-down" size={17} color="#6D6D6D" />
          </TouchableOpacity>
          ...
          {/* Vehicle Type */}
          <SectionTitle title="Vehicle Type" style={styles.title} />
...
const vehicleOptions = [
  { id: 1, name: "Bike", image: "selected_bike" },
  { id: 2, name: "Car", image: "car" },
  { id: 3, name: "Lorry", image: "lorry" },
];
